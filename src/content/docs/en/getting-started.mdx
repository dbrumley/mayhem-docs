...
<CardGrid>
  ...
  <SplitCard title="Take a guided tour" icon="rocket">
    Complete our introductory Build a Calculator to learn the basics of
    setting up an application with Mayhem integrated into CICD. 
  </SplitCard>


  <Card title="Learn about Mayhem" icon="star">
    Learn about [how Mayhem, fuzzing, and dynamic analysis
    work](/en/concepts/how-mayhem-works) to help you improve the security and
